...
public class MarketStatsAgent extends Agent {
    ...
    protected void setup() {
        ...
        // Initialize logging
        try {
            logWriter = new PrintWriter(new FileWriter("trading_session_" + 
                System.currentTimeMillis() + ".log"));
            logWriter.println("=== TRADING SESSION LOG ===");
        ...
        addBehaviour(new WakerBehaviour(this, 1000) {
            ...
            protected void onWake() {
                ...
                if (marketMaker != null) {
                    ...
                    addBehaviour(new PeriodicReportBehaviour(myAgent, 10000)); // Report every 10 seconds
                    addBehaviour(new MarketAlertBehaviour(myAgent, 5000)); // Check alerts every 5 seconds
                }
            }
        });
    }
    ...
    private class MarketDataMonitor extends CyclicBehaviour {
        ...
        private void processMarketData(String data) {
            ...
            double volatility = Double.parseDouble(parts[10]);
    ...
    private class TradeMonitor extends CyclicBehaviour {
        ...
        private void processTrade(String tradeData) {
            // Parse: TraderName:BUY/SELL:Symbol:Quantity:Price
            ...
            if (quantity * price > 5000) { // Trades over $5000
